...
@section('content')
        ...
        <div class="col-8">
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">   أضافة ممثل لجنة المشاريع </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
            {{Form::open(['url'=>"administrator/users/add/ProjectCommittee"]) }}
                <div class="card-header text-center">
                   <strong>   أضافة ممثل لجنة المشاريع  </strong>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group col-lg-12 col-md-12">
                        <label for="IsActive"><span style="color:red;">*</span><strong>هل ترغب في تفعيل هذا الحساب ؟</strong></label>
                    </div>
