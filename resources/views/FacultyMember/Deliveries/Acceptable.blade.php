@foreach($Group->delivs as $d)
    <div class="modal fade" id="Acceptable-{{$d->id}}" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {!! Form::open(['url'=>["FacultyMember/deliveries/$d->id/1"]]) !!}
                    <div class="modal-body"> 
                        {!! Form::textarea('Note',null,['id'=>'Note','class'=>'form-control','placeholder'=>'اترك ملاحظتك حول التسليم','title'=>'ملاحظات']) !!}         
                    </div>
                    <div class="modal-footer ">
                        <button type="submit" class="btn btn-success"> <i class="fa fa-check-circle-o"></i> قبول</button>
