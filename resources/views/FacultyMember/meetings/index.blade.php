...
@section('content')
    ...
    @unless(count($GroupB)==0 && count($GroupG)==0)
        <h3 class="page-header">
            <strong>لقاءات المجموعات التي تشرف عليها</strong>
        </h3>
        @if(count($GroupB)!=0)
                    ...
                    <div class="table-responsive ">
                        <table class="table table-bordered table-hover col-lg-12">
                            ...
                            @foreach($GroupB as $g)
                                ...
                                <th>
                                    <a title="اللقاءات السابقة" href="{{ url("FacultyMember/meeting/$g->id/show") }}"  class="btn btn-info btn-xs">اللقاءات السابقة</a>
                                </th>
