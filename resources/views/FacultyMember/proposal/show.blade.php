...
@section('content')
    ...
    <div class="blockquote-box clearfix table-responsive">
        ...
        @if($Proposal->References ==0 && $Proposal->Certified ==0)
            ...
            <div class="alert alert-info text-left" role="alert">
                ...
                <a title="تعديل" href="{{url("FN-Proposal/$Proposal->id/edit")}}"> <button type="button" class="btn btn-warning "><i class="fa fa-edit"></i> تعديل</button></a>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $Proposal->AcademicYear !=null ?  $Proposal->AcademicYear : 'لايوجد أي بيانات ليتم عرضها!.' }}</td>
                            <td>{{ $Proposal->Semester !=null ? $Proposal->Semester : 'لايوجد أي بيانات ليتم عرضها!.' }}</td>
    ...
    @include('FacultyMember.proposal.delete')
@endsection           
