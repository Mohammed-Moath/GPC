        ...
        <div class="container-fluid">
            ...
            <div class="row"> 
                @if( $NameGroups == "الطلاب")
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="list-group text-center">
                            <a title="التسليمات"  class="list-group-item list-group-item-info disabled  group-q">
                ...
                @if( $NameGroups == "الطالبات")
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="list-group text-center">
                            <a title="التسليمات" href="{{ url('follow-up/grils',3) }}" class="list-group-item list-group-item-info disabled group-q">
                                <strong>التسليمات </strong>
                            </a>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a title="تفاصيل" href="{{ url("follow-up/group/$TypeGroups/$g->id/deliveries") }}" class="btn btn-primary btn-xs "><i class="fa fa-folder-open"></i> تفاصيل</a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
