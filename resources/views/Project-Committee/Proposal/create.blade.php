...
@section('content')
        ...
        <div class="col-8">
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> أضافة مقترح</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="row">
        <div class="col">
            <div class="card ">
                {!! Form::open(["url"=>"project-committee/proposal/create"]) !!} 
                    <div class="card-header text-center ">
                        <span class="badge badge-pill badge-success"> أضافة مقترح</span>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('Program') ? ' has-error' : '' }} ">
                                    ...
                                    <div class="table-responsive ProgramChoose">
                                        <table class="table table-sm table-hover  table-bordered">
                                            <thead>
                                                <tr class="table-dark">
                                                <th scope="col"  title="تحديد الكل">
                                                    <label class="custom-control custom-checkbox ">
                                                        <input class="custom-control-input" type="checkbox" onchange="checkAll(this)">
                                            ...
                                            <tbody>
                                                @foreach(Program() as $p)
                                                    <tr>
                                                        <th scope="row"> 
                                                            <label class="custom-control custom-checkbox ">
                                                                <input class="custom-control-input" title="هل تريد اختيار هذا التخصص  : {{$p->ProgramName}}؟" type="checkbox" name="Program[]" value="{{$p->id}}">
                                                                <span class="custom-control-indicator"></span>
                                                            </label>
                                                        </th>
...
@section('footer')
    ...
    <script>
        function checkAll(e) {
            var checkboxes = document.getElementsByName('Program[]');
