...
<head>
  ...
  {!! Html::style('Templates/Shared-files/css/Administrator.css') !!}

  @yield('header')
</head>

<body class="fixed-nav sticky-footer bg-dark do-nicescrol" id="page-top">
  <!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top " id="mainNav">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <ul class="navbar-nav navbar-sidenav NiceScroll" id="exampleAccordion">
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="التهيئة">
            ...
            <ul class="sidenav-second-level collapse" id="collapseConfiguration">
              <li>
                <a href="{{ url('administrator/configuration/public') }}"> عام</a>
              </li>
              <li>
                <a href="{{ url('administrator/configuration/data')}}"> بيانات</a>
              </li>
            </ul>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="المستخدمين">
            <a class="nav-link" href="{{ url('administrator/users') }}">
              <i class="fa fa-users"></i>
              <span class="nav-link-text">المستخدمين</span>
            </a>
          </li>
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="الاعلانات">
            <a class="nav-link" href="{{ url('under-construction') }}">
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="#"><i class="fa fa-fw fa-user"></i> صفحتي الشخصية</a>
  ...
  <div class="content-wrapper">
    ...
    {!! Html::script('Templates/Shared-files/js/jquery.nicescroll.min.js') !!}
    ...
    {!! Html::script('Templates/Shared-files/js/Administrator.js') !!}
