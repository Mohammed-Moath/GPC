...
<html lang="en">
    ...
    <head>
        ...
        <!-- Custom CSS -->
        {!! Html::style('admin/css/student.css') !!}
    ...
    <body id="StudentBody">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li>
                            <a title="الرئيسية" href="{{ url('home/student')}}"><i class="fa fa-home"></i> الرئيسية</a>
                        </li>
                        <li>
                            <a title="مقترحاتي" href="{{ url('student/my-proposals') }}"><i class="fa fa-lightbulb-o"></i> مقترحاتي</a>
                        </li>
                        <li> 
                            <a title="مجموعتي" href="{{ url('student/my-group') }}"><i class="fa fa-users" aria-hidden="true"></i> مجموعتي</a>
                        </li>
                        <li>
                            <a title="اللقاءات"href="{{ url('student/meetings') }}"><i class="fa fa-video-camera"></i>  اللقاءات</a> 
                        </li>
                        <li>
                            <a title="التسليمات"href="{{ url('student/deliveries') }}"><i class="fa fa-book"></i>  التسليمات</a> 
                        </li>
                        <li class="dropdown">
                            <a title="انقر لعرض المزيد" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-check-square-o"></i>  تقيماتي  
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <a href="{{ url('student/attendance') }}">الحضور والغياب</a>
                                </li>
                                <li role="separator" class="divider"></li>
                                <li>
                                    <a href="{{ url('student/grades') }}"> الدرجات</a>
                                </li>  
                            </ul>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav navbar-left">    
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                            <li>
                                    <a href="{{ url('student/x') }}"><i class="fa fa-fw fa-user"></i> صفحتي الشخصية</a>
                                </li>
                                <li>
                                    <a href="{{ url('student/x') }}"><i class="fa fa-fw fa-gear"></i> الاعدادات</a>
                                </li>  
                                <li role="separator" class="divider"></li>
                            <li>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <ul class="list-unstyled">
                                    <li>
                                        <a title="تقديم مقترح مشروع" href="{{ url('student/create/proposals') }}"> تقديم مقترح مشروع</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                <ul class="list-unstyled">
                                    <li><a title="مقترحات مشاريع التخرج" href="{{ url('student/selection/proposals') }}">مقترحات مشاريع التخرج </a>        
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-lg-6 -->
                            <div class="col-lg-6">
                                <ul class="list-unstyled">
                                    <li><a title="مجموعات مشاريع التخرج" href="{{ url('student/group') }}">مجموعات مشاريع التخرج</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-lg-6 -->
        ...
        {!! Html::script('admin/js/student.js') !!}
