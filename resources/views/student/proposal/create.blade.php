...
@section('content')
    ...
    <hr>
    <div class="Outputs">
        {!! Form::open(["url"=>"student/create/proposals"]) !!}
            <div class="form-group col-md-12">
                <label for="AcademicYear"> <i class="fa fa-caret-left"></i> التقويم :</label>
                <input  title="التقويم" type="text" class="form-control" readonly disabled
                value="        @if(Calendar_Current()->Name == null)لايوجد بيانات ليتم عرضها !@endif 
                @if(Calendar_Current()->Name != null){{Calendar_Current()->Name}} @endif">
                </input>
            </div>
