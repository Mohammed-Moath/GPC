@if($Proposal->References ==0 && $Proposal->Certified ==0)
        ...
        <div id="myModal" class="modal fade" role="dialog">
            <div class="modal-dialog">
                ...
                {!! Form::open(["url"=>['student/proposals',$Proposal->id,'delete']]) !!}
                    <div class="modal-body">
                        <div class="alert alert-danger"><span class="glyphicon glyphicon-warning-sign"></span> <strong>هل أنت متاكد من حذف المقترح :  </strong> {{ isset($Proposal->ProjectProposalTitle) !=null ?  $Proposal->ProjectProposalTitle : 'لايوجد أي بيانات ليتم عرضها!.' }} </div>
                    </div>
